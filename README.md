...
- [tema4 (2).pdf](./tema4%20(2).pdf) — звіт до практичного заняття
...
Приклади були створені та перевірені у **Visual Studio**.  
У звіті наведено теоретичні пояснення та практичні ілюстрації з реальними скрінами виконання програм.
